		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Route, { path: '/details/:id', component: Details, onEnter: this.assigShow })
				)
			);
		}
	});
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { onChange: this.handleSearchTermEvent, value: this.state.searchTerm, className: 'seach-input', type: 'text', placeholder: 'Search' })
				),
				React.createElement(
					'div',
					{ className: 'shows' },
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement('iframe', { src: 'https://www.youtube-nocookie.com/embed/' + trailer + '\n\t\t\t\t\t?rel=0&amp;controls=0&amp;showinfo=0', frameBorder: '0',
